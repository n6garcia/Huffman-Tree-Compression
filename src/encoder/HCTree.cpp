...
/**
 * TODO: Write the encoding bits of the given symbol to the ostream. You
 * should write each encoding bit as ascii char either '0' or '1' to the
 * ostream. You must not perform a comprehensive search to find the encoding
 * bits of the given symbol, and you should use the leaves vector instead to
 * achieve efficient encoding. For this function to work, build() must be
 * called before to create the HCTree.
 */
